...
microclimate_shield_date_day$radiation <- scale(microclimate_shield_date_day$radiation)

priors<-prior(cauchy(0,0.5), coef=midshield_binomial)

m_max_T_95_shield_date_day <- brm(
  max_T2_95 ~ midshield_binomial * radiation + (1|div) + (1|treatment) + (1|dist_wall) + (1 | Date),
  prior=priors,
