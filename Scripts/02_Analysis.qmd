...
# Sensitivity analysis for Day per day
m_max_T_90_shield_date_day <- update(m_max_T_90_shield_date_day, formula = max_T2_90 ~ ., newdata = microclimate_shield_date_day)
...
pp_check(m_max_T_95_shield_date_night)
