...
#For the total
m_max_T_shield_day = brm(max_T2_95 ~ midshield + (1|div), data = microclimate_shield_day,   chains = 4, 
  iter=4000,
  warmup=1000)
...
pp_check(m_max_T_shield_date_day, type = "dens_overlay")

pp_check(m_max_T_shield_date_day, type = "stat", stat = "mean")

plot(marginal_effects(m_max_T_shield_date_day))
